...
- scaffold/PROJECT-KNOWLEDGE.md: hard-won understanding, pitfalls, and context that should survive new agent sessions. Agents may create and edit this file.
- scaffold/skills/: per-project Cursor agent skills (folders with SKILL.md). Create skills here when asked; do not invent skills unprompted.
